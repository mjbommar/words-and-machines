...
\subsection{A memory injection relates blocks, offsets, and permissions}
...
\subsection{The synchronization table is the proof skeleton}
...
\subsection{A translator needs an explicit fault policy}
...
\subsection{Returns relate continuations, not only result registers}
