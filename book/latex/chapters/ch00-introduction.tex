...
the source-pinned twelve-form RV64I slice used by the book. Their reports and
negative controls replay from the repository. Axeyum must still gain the
source-pinned x86-64 slice and typed cross-machine state relations before the
later chapters can claim three-machine refinement proofs. A handwritten
bit-vector identity is not a substitute for those layers.
