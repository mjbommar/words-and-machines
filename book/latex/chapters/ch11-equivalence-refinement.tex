...
\section{Real instructions make the observation concrete}
...
\subsection{A simulation turns endpoint hope into a step argument}
...
\subsection{Undefined behavior makes compiler refinement asymmetric}
...
\section{Translation validation is a production tradeoff}
